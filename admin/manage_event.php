...
<style>
    ...
    align-items: center;
    flex-wrap: wrap;
	/*  check iamge size and width booking.png  */
}
	#uploads {
		min-height: 15vh;
	width: calc(100%);
	...
	input[type=checkbox]
{
  ...
  -webkit-transform: scale(1.5); /* scael : 45 Safari and Chrome  update version driver 19.4 aviable */
		...
		<div class="card">
			<div class="card-body">
				<form action="" id="manage-event">
					...
					<div>
						<div>check this table - div | recover path | fra - clc / pr-makavwan - push branch</div>
						<div>check this table - div | recover path | fra - clc / pr-kr - push branch</div>
						<div>check this table - div | recover path | fra - clc / pr-llc456 - push branch</div>
						<div>check this table - div | recover path | fra - clc / pr-ch nn\ not get error_clear_last - push branch</div>
						<div>check this table - div | recover path | fra - clc / pr-makavwan | node not found error  - push branch</div>
					</div>
					<div class="row">
						<div class="col-md-12">
...
function addEventHandler(obj, evt, handler) {
  if (obj.addEventListener) {
    // W3C method  : chcek this protocall and than go for it 
...
//  check o.p and give working properly 
//  t- o/p feedback give u an next response 
//  
...
rem_func()
	...
	// we can give dynamic o/p of this 
	//  
