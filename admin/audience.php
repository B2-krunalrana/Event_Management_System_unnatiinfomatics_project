	...
	input[type=checkbox]
{
  ...
  -webkit-transform: scale(1.5); /* Safari and Chrome --- cheeck update drive here 19.2 version avivble  */
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					...
					setTimeout(function(){
						location.reload()
						// chek the op in post man once is give or exterct data than and than u can find op in it  
						//  u can use post man plug in here better post man ++  
						// $.ajax({
						// url:'ajax.php?action=delete_register',
						// method:'POST',
						// data:{id:$id},
						...
						// 		setTimeout(function(){
						// 			location.reload()
						// check thw class and input data 
						//  
					},1500)
